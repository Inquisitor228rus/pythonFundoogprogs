...
def button3(): #КОЛОМНА
    ...
    time.sleep(Pause_Sleep)
    worksheet['D4'] = kolomna11
    worksheet['E4'] = kolomna12
    worksheet['G4'] = kolomna13
    ...
    time.sleep(Pause_Sleep)
    ws1 = worksheet['D4'] = kolomna11
    ws1 = worksheet['E4'] = kolomna12
    ws1 = worksheet['G4'] = kolomna13
    ...
    time.sleep(Pause_Sleep)
    ws2 = worksheet['D4'] = kolomna21
    ws2 = worksheet['E4'] = kolomna22
    ws2 = worksheet['G4'] = kolomna23
    ...
    time.sleep(Pause_Sleep)
    ws3 = worksheet['D4'] = kolomna31
    ws3 = worksheet['E4'] = kolomna32
    ws3 = worksheet['G4'] = kolomna33
    ...
    time.sleep(Pause_Sleep)
    ws4 = worksheet['D4'] = kolomna41
    ws4 = worksheet['E4'] = kolomna42
    ws4 = worksheet['G4'] = kolomna43
    ...
    time.sleep(Pause_Sleep)
    ws5 = worksheet['D4'] = kolomna51
    ws5 = worksheet['E4'] = kolomna52
    ws5 = worksheet['G4'] = kolomna53
...
def button4(): #ЛУХОВИЦЫ
    ...
    time.sleep(Pause_Sleep)
    ws1 = worksheet['D4'] = luh11
    ws1 = worksheet['E4'] = luh12
    ws1 = worksheet['G4'] = luh13
    ...
    time.sleep(Pause_Sleep)
    ws2 = worksheet['D4'] = luh21
    ws2 = worksheet['E4'] = luh22
    ws2 = worksheet['G4'] = luh23
    ...
    time.sleep(Pause_Sleep)
    ws3 = worksheet['D4'] = luh31
    ws3 = worksheet['E4'] = luh32
    ws3 = worksheet['G4'] = luh33
